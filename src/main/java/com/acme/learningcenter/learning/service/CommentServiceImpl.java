...
public class CommentServiceImpl implements CommentService {
    ...
    public Comment create(Long postId, Comment request) {
        ...
        return postRepository.findById(postId).map(post ->
                commentRepository.save(request.withPost(post))).orElseThrow(() -> new ResourceNotFoundException("Post", postId));
    ...
    public Comment update(Long postId, Long commentId, Comment request) {
        ...
        return commentRepository.findById(commentId).map(comment -> commentRepository.save(comment.withText(request.getText())))
